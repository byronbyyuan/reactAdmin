module.exports = {
    ...
    "rules": {
      ...
      "camelcase": 0, //强制驼峰法命名
      "jsx-quotes": 0, //[2, "prefer-double"], //强制在JSX属性（jsx-quotes）中一致使用双引号
      ...
      "react/jsx-no-duplicate-props":0, //2 //防止在JSX中重复的props
      ...
      "react/no-direct-mutation-state": 0,//2, //防止this.state的直接变异
      ...
      "react/jsx-equals-spacing":0, //2, //在JSX属性中强制或禁止等号周围的空格
      "no-unreachable": 0,//1, //不能有无法执行的代码
